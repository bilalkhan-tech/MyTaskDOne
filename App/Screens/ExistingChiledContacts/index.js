...
const phone=route.params.data.Contactnumber
...
setchiledName(firstname+' '+lastname)
setChiledContact(phone)

const Id=route.params.data.linkdata.Id
const image=route.params.data.linkdata.image
setParentId(Id)
